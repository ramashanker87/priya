...
# STEP 1 – Create CodeCommit Repository
    ...
    - Repository name: devops-training-repo
     ...
     aws codecommit create-repository \
      --repository-name devops-training-repo-priya \
...
#  STEP 5 – Create S3 Bucket
    ...
    - devops-training-build-artifacts-priya

---


#  STEP 7 – CodeBuild Project
    project name: devops-build-priya
    Source: CodeCommit
    repository: devops-training-repo-priya
    Branch: master
    ...
    Artifacts :S3
    Bucket Name: devops-training-build-artifacts-priya
    Name: output
    Path: (empty)
