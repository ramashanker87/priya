...
```bash
docker build -t priya-hello-ecr:v1 .
```

## If you are unable to connect. (Optional) Run Docker Without sudo
...
```bash
docker run -d --name hello-app -p 8080:8080 priya-hello-ecr:v2
...
--repository-name priya-hello-ecr \
...
386757865964.dkr.ecr.us-east-1.amazonaws.com/priya-hello-ecr:v2
```
