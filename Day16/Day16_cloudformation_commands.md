...
aws cloudformation deploy \
  ...
  --parameter-overrides \
      ...
      ECRImage=386757865964.dkr.ecr.us-east-1.amazonaws.com/priya-ecr:v2 \
  --profile devops
```
...
aws logs describe-log-streams \
  --log-group-name /ecs/priya-fargate-cluster \
  --region us-east-1 \
  --profile devops
```
