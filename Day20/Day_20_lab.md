...
export CLUSTER_NAME=day20-eks-helm-scaling-priya
export NODEGROUP_NAME=day20-managed-ng-priya
export APP_NAME=day20-web-priya
export NAMESPACE=day20-priya
...
kind: Deployment
metadata:
  name: {{ include "day20-web-priya.fullname" . }}
  labels:
...
spec:
  ...
  selector:
    matchLabels:
      {{- include "day20-web-priya.selectorLabels" . | nindent 6 }}
  template:
    metadata:
      labels:
        {{- include "day20-web-priya.selectorLabels" . | nindent 8 }}
    spec:
      containers:
        - name: {{ .Chart.Name }}
...
metadata:
  name: {{ include "day20-web-priya.fullname" . }}
  labels:
    {{- include "day20-web-priya.labels" . | nindent 4 }}
spec:
  ...
  ports:
    - port: {{ .Values.service.port }}
      ...
      name: http
  selector:
    {{- include "day20-web-priya.selectorLabels" . | nindent 4 }}
EOF
```
